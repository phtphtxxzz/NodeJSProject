...
_a = ImageResize;
ImageResize.CheckImageExist = (filename) => __awaiter(void 0, void 0, void 0, function* () {
...
ImageResize.ResizeImage = (filename, width, height) => __awaiter(void 0, void 0, void 0, function* () {
    const originImagePath = path_1.default.join(originImageDir, `${filename}.jpg`);
